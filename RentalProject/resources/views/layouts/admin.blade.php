    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-primary topbar mb-4 static-top shadow" style="background-color: #F1BC00">
                    <a class="navbar-brand" href="{{ route('dashboard.index') }}" style="color: black">YukRental</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; YukRental Website 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
